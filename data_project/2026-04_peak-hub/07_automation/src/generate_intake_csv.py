...
例:
  python generate_intake_csv.py --source baseconnect --output ../../03_data_processed/intake/
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="../../03_data_processed/intake",
        help="出力ディレクトリ（デフォルト: ../../03_data_processed/intake）",
    )
