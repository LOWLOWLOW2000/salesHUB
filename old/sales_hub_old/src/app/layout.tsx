...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className={`${geistSans.className} min-h-full flex flex-col bg-zinc-50 text-zinc-950`}>
        ...
        <main className="flex-1">
          <div className="mx-auto w-full px-4 py-10 sm:px-6 lg:px-8">{children}</div>
        </main>
        <footer className="border-t border-zinc-200/70 bg-white">
          <div className="mx-auto w-full px-4 py-6 text-xs text-zinc-600 sm:px-6 lg:px-8">
            {appConfig.name}
          </div>
        </footer>
      </body>
