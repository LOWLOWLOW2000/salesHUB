...
import { ProjectManagementTool } from '@/app/_components/tools/ProjectManagementTool'
    ...
    <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
      ...
      <article className="min-w-0 flex-1 space-y-5">
        ...
        {activeId === 'project-management' ? (
          <ProjectManagementTool projectId={projectId} canConfigure={capabilities.canConfigure} />
        ) : null}

        {activeId !== 'daily-report' &&
        activeId !== 'kpi-dashboard' &&
        activeId !== 'is-ops' &&
        activeId !== 'project-management' &&
        section ? (
          <>
